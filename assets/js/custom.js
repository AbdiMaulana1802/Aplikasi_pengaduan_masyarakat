...
$(document).ready(function() {
    ...
    $(
            '#loading-simpan, #loading-ubah, #loading-hapus, #pesan-error, #pesan-sukses, #btn-reset'
        ).hide()
    ...
    $('#view').on('click', '.btn-form-ubah', function() {
            ...
            var tanggal = tr.find('.tanggal-value').val()
            var nik = tr.find('.nik-value').val() // Ambil nis dari input type hidden
            var judul = tr.find('.judul-value').val()
            var isi = tr.find('.isi-value').val()

            var status = tr.find('.status-value').val()
            ...
            $('#tanggal').val(tanggal) // Set value dari textbox nama yang ada di form
            $('#nik').val(nik) // Set value dari textbox nis yang ada di form
            $('#judul').val(judul) // Set value dari textbox nama yang ada di form
            $('#isi').val(isi) // Set value dari textbox nama yang ada di form
                // Set value dari textbox nama yang ada di form
